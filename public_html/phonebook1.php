...
<body>
  ...
  <header id="header" class="fixed-top header-inner-pages">
        ...
        <ul>
          ...
          <li><a class="nav-link scrollto" href="index.html">My Skill</a></li>
          <li class="dropdown"><a href="#"><span>Phonebook</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
  ...
  <main id="main">
    ...
    <section class="inner-page">
      <div class="container">
        <p>
                        <b><i>LOG IN TO USE API AND ADD NEW USER</i></b>
        </p>
      </div>
    </section>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="index.html">About me</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="index.html">Skills</a></li>
